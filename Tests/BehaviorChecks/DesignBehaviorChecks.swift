...
struct DesignBehaviorChecks {
    ...
    private static func checkAlbumDetailStartsAtTopAfterHidingTitleBar() throws {
        ...
        precondition(source.contains("contentTop: AlbumDetailLayout.scrollContentTopInset"))
        ...
        precondition(source.contains("var contentInsets = scrollView.contentInsets"))
    ...
    private static func checkSearchViewUsesFloatingSearchField() throws {
        ...
        precondition(source.contains("contentTop: SearchChromeMetrics.contentTopInset"))
