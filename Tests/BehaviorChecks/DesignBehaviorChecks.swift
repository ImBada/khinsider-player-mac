...
struct DesignBehaviorChecks {
    static func main() throws {
        ...
        try checkFavoriteSongRowsCanToggleFavorites()
    ...
    private static func checkAlbumTopChromeIncludesWebButton() throws {
        ...
        precondition(!source.contains("AlbumMoreMenuPresenter"))
    ...
    private static func checkAlbumTopBarAppearsOnlyAfterScrolling() throws {
        ...
        precondition(source.contains("AlbumTopChrome("))
        precondition(source.contains("title: album.title"))
        precondition(source.contains("subtitle: collapsedSubtitle(for: album)"))
        precondition(source.contains("isCollapsedTopBarVisible: shouldShowCollapsedTopBar"))
        ...
        precondition(!source.contains(".safeAreaInset(edge: .top, spacing: 0)"))
        ...
        precondition(source.contains("AlbumTopControls("))
        precondition(source.contains(".background(alignment: .top)"))
        precondition(source.contains("AlbumCollapsedTopBar("))
        precondition(source.contains(".allowsHitTesting(false)"))
        precondition(source.contains(".fill(.regularMaterial)"))
        precondition(!source.contains("isDragAreaVisible"))
        precondition(!source.contains("static let collapsedTopBarZIndex"))
        precondition(!source.contains("static let topControlsZIndex"))
        precondition(source.contains("albumURL: album.url"))
        precondition(source.contains(".padding(.horizontal, AlbumDetailLayout.topControlHorizontalPadding)"))
        precondition(source.contains(".padding(.top, AlbumDetailLayout.topControlsTopPadding)"))
        precondition(source.contains("Button {\n                onBack()"))
        precondition(source.contains("HStack(spacing: 0)"))
        precondition(source.contains("width: AlbumDetailLayout.topControlButtonSize"))
        precondition(source.contains("height: AlbumDetailLayout.topControlButtonSize"))
        precondition(source.contains("AlbumTopBarDragArea()"))
        precondition(source.contains(".frame(maxWidth: .infinity)"))
        precondition(source.contains("alignment: .topTrailing"))
        precondition(!source.contains("AlbumMoreControl(albumURL: albumURL, onOpenInBrowser: onOpenInBrowser)"))
        precondition(!source.contains("private struct AlbumBackControl: View"))
        precondition(!source.contains("private struct AlbumMoreControl: View"))
        precondition(source.contains("Menu {"))
        precondition(!source.contains("_isBackHovered"))
        precondition(!source.contains("_isBackPressed"))
        precondition(!source.contains("backControl"))
        precondition(!source.contains("AlbumBackHitTarget"))
        precondition(!source.contains("topControlFeedbackSize"))
        precondition(!source.contains("TapGesture"))
        precondition(!source.contains("AlbumBackMouseDownTarget"))
        precondition(!source.contains("private struct AlbumMoreMenuTarget: NSViewRepresentable"))
        precondition(!source.contains("AlbumMoreMenuPresenter"))
        precondition(source.contains("override func mouseDown(with event: NSEvent)"))
        precondition(source.components(separatedBy: ".buttonStyle(.glass)").count >= 3)
        precondition(source.components(separatedBy: ".buttonBorderShape(.circle)").count >= 3)
        precondition(!source.contains("AlbumBackButton(onBack: onBack)"))
        precondition(!source.contains("private struct AlbumBackButton: NSViewRepresentable"))
        precondition(!source.contains("BackButtonView: NSVisualEffectView"))
        precondition(!source.contains("let button = NSButton()"))
        precondition(source.contains("private struct AlbumTopBarDragArea: NSViewRepresentable"))
        precondition(!source.contains("AlbumTopBarDragArea(isVisible:"))
        precondition(!source.contains(".padding(.horizontal, AlbumDetailLayout.topControlDragExclusionWidth)"))
        precondition(!source.contains(".albumTopControlHitArea"))
        precondition(!source.contains("topControlHitExclusionRects"))
        ...
        precondition(!source.contains("static let topControlsZIndex"))
        precondition(source.contains("static let topControlHorizontalPadding: CGFloat = 8"))
        precondition(!source.contains("static let topControlDragExclusionWidth"))
        precondition(!source.contains("topControlHitAreaWidth"))
    }
    ...
    private static func checkAlbumDetailStartsAtTopAfterHidingTitleBar() throws {
        let source = try sourceFile("Sources/KHPlayer/Features/Album/AlbumDetailView.swift")
        let scrollerSource = try sourceFile("Sources/KHPlayer/App/TopInsetScroller.swift")

        precondition(source.contains("scrollContentTopSpacer"))
        precondition(source.contains("static let scrollContentTopInset = topChromeHitExclusionHeight"))
        precondition(source.contains("static let scrollIndicatorTopInset = topChromeHitExclusionHeight - topControlsTopPadding"))
        precondition(source.contains(".frame(height: AlbumDetailLayout.scrollContentTopInset)"))
        precondition(source.contains("ScrollIndicatorInsetsSetter("))
        precondition(source.contains("scrollerTop: AlbumDetailLayout.scrollIndicatorTopInset"))
        precondition(source.contains("override func viewDidMoveToWindow()"))
        precondition(source.contains("override func layout()"))
        precondition(source.contains("NSView.frameDidChangeNotification"))
        precondition(source.contains("scrollView.postsFrameChangedNotifications = true"))
        precondition(source.contains("@objc private func scrollViewFrameDidChange"))
        precondition(source.contains("detachScrollViewFrameObserver()"))
        precondition(source.contains("@discardableResult"))
        precondition(source.contains("applyScrollIndicatorInsetNow() -> Bool"))
        precondition(source.contains("TopInsetScroller.install(on: scrollView, topInset: scrollerTop)"))
        precondition(source.contains("scrollView.tile()"))
        precondition(!source.contains("scrollView.scrollerInsets = insets"))
        precondition(!source.contains("insets.top = scrollerTop"))
        precondition(!source.contains("scrollView.contentInsets = contentInsets"))
        precondition(!source.contains("contentInsets.top = contentTop"))
        precondition(!source.contains(".modifier(ScrollIndicatorInsetsModifier(top: AlbumDetailLayout.scrollContentTopInset))"))
        precondition(!source.contains("private struct ScrollIndicatorInsetsModifier: ViewModifier"))
        precondition(!source.contains(".modifier(ScrollOffsetTrackingModifier { offsetY in\n                scrollOffsetY = offsetY\n            })\n            .padding(.top, AlbumDetailLayout.scrollContentTopInset)"))
        precondition(!source.contains(".padding(.top, AlbumDetailLayout.headerTopPadding)"))
        precondition(!source.contains("static let headerTopPadding"))
        precondition(!source.contains(".padding(.top, 70)"))
        precondition(scrollerSource.contains("internal final class TopInsetScroller: NSScroller"))
        precondition(scrollerSource.contains("scrollView.verticalScroller = replacementScroller"))
        precondition(scrollerSource.contains("override internal func rect(for part: NSScroller.Part) -> NSRect"))
        precondition(scrollerSource.contains("guard part == .knob"))
        precondition(scrollerSource.contains("let slot = super.rect(for: .knobSlot)"))
        precondition(scrollerSource.contains("private func topPaddedSlot(from slot: NSRect) -> NSRect"))
        precondition(scrollerSource.contains("if scrollerInsets.top != 0"))
        precondition(scrollerSource.contains("scrollerInsets.top = 0"))
        precondition(scrollerSource.contains("override internal var isOpaque: Bool"))
        precondition(scrollerSource.contains("override internal func draw(_ dirtyRect: NSRect)"))
        precondition(scrollerSource.contains("override internal func drawKnobSlot(in slotRect: NSRect, highlight flag: Bool) {}"))
        precondition(scrollerSource.contains("override internal func drawKnob()"))
        precondition(scrollerSource.contains("let width: CGFloat = 8"))
        precondition(scrollerSource.contains("NSColor(\n            calibratedWhite:"))
        precondition(scrollerSource.contains("roundedRect: polishedKnobRect"))
    }
    ...
    private static func checkSearchViewUsesFloatingSearchField() throws {
        ...
        precondition(source.contains("internal static let scrollIndicatorTopInset = contentTopInset - headerTopPadding"))
        ...
        precondition(source.contains("SearchScrollIndicatorInsetsSetter("))
        precondition(source.contains("scrollerTop: SearchChromeMetrics.scrollIndicatorTopInset"))
        precondition(source.contains("private struct SearchScrollIndicatorInsetsSetter: NSViewRepresentable"))
        precondition(source.contains("NSView.frameDidChangeNotification"))
        precondition(source.contains("searchScrollView.postsFrameChangedNotifications = true"))
        precondition(source.contains("@objc private func scrollViewFrameDidChange"))
        precondition(source.contains("detachScrollViewFrameObserver()"))
        precondition(source.contains("@discardableResult"))
        precondition(source.contains("applyScrollIndicatorInsetNow() -> Bool"))
        precondition(source.contains("TopInsetScroller.install(on: searchScrollView, topInset: scrollerTop)"))
        precondition(!source.contains("searchScrollView.scrollerInsets = scrollerInsets"))
        precondition(!source.contains("searchScrollView.contentInsets = contentInsets"))
        precondition(!source.contains("contentInsets.top = contentTop"))
    ...
    private static func checkAlbumTopControlsMatchMusicChromePlacement() throws {
        ...
        precondition(albumSource.contains("static let scrollContentTopInset = topChromeHitExclusionHeight"))
        precondition(!albumSource.contains("static let headerTopPadding"))
        precondition(albumSource.contains("ZStack(alignment: .top)"))
        precondition(!albumSource.contains(".safeAreaInset(edge: .top, spacing: 0)"))
    ...
    private static func checkAlbumTopControlsUseNativeGlassOnly() throws {
        ...
        precondition(!source.contains("static let topControlFeedbackSize"))
        precondition(!source.contains("AlbumBackHitTarget("))
    ...
    private static func checkFavoritesListsUseMusicHoverAndSongTable() throws {
        ...
        precondition(libraryView.contains("private var _removedFavoriteAlbumIDs = State<Set<String>>(initialValue: [])"))
        precondition(libraryView.contains("private var _removedFavoriteAlbumDetails = State<[String: AlbumDetail]>(initialValue: [:])"))
        ...
        precondition(libraryView.contains("onToggleFavoriteAlbum: {\n                                toggleFavoriteAlbum(album)\n                            }"))
        ...
        precondition(libraryView.contains("private struct FavoriteAlbumFavoriteButton: View"))
        precondition(libraryView.contains("isFavorite: !removedFavoriteAlbumIDs.contains(album.id)"))
        precondition(libraryView.contains("isHovered: hoveredFavoriteAlbumID == album.id"))
        precondition(libraryView.contains("Image(systemName: isFavorite ? \"star.fill\" : \"star\")"))
        precondition(libraryView.contains(".opacity(isHovered ? 1 : 0)"))
        precondition(libraryView.contains("try appState.libraryStore.removeFavoriteAlbum(album)"))
        precondition(libraryView.contains("try appState.libraryStore.restoreFavoriteAlbum(\n                    album,\n                    albumDetail: removedFavoriteAlbumDetails[album.id]\n                )"))
        precondition(libraryView.contains("removedFavoriteAlbumIDs.insert(album.id)"))
        precondition(libraryView.contains("removedFavoriteAlbumIDs.remove(album.id)"))
        precondition(libraryView.contains("removedFavoriteAlbumDetails[album.id] = cachedAlbumDetail"))
        precondition(libraryView.contains("removedFavoriteAlbumDetails.removeValue(forKey: album.id)"))
        precondition(libraryView.contains("static let albumFavoriteColumnWidth: CGFloat = 24"))
    ...
    private static func checkFavoriteSongRowsCanToggleFavorites() throws {
        let libraryView = try sourceFile("Sources/KHPlayer/Features/Library/LocalLibraryViews.swift")
        let store = try sourceFile("Sources/KHPlayer/Persistence/LibraryStore.swift")

        precondition(libraryView.contains("private var _removedFavoriteTrackIDs = State<Set<String>>(initialValue: [])"))
        precondition(libraryView.contains("private var _removedFavoriteTrackAlbumDetails = State<[String: AlbumDetail]>(initialValue: [:])"))
        precondition(libraryView.contains("removedFavoriteTrackIDs = []"))
        precondition(libraryView.contains("removedFavoriteTrackAlbumDetails = [:]"))
        precondition(libraryView.contains("isFavorite: !removedFavoriteTrackIDs.contains(entry.id)"))
        precondition(libraryView.contains("isHovered: hoveredTrackID == entry.id"))
        precondition(libraryView.contains("onToggleFavoriteTrack: toggleFavoriteTrack"))
        precondition(libraryView.contains("TableColumn(\"☆\") { entry in\n                FavoriteSongFavoriteCell("))
        precondition(libraryView.contains(".width(min: FavoriteListLayout.songFavoriteColumnWidth, ideal: FavoriteListLayout.songFavoriteColumnWidth, max: FavoriteListLayout.songFavoriteColumnWidth)"))
        precondition(libraryView.contains("private struct FavoriteSongFavoriteCell: View"))
        precondition(libraryView.contains("let isHovered: Bool"))
        precondition(libraryView.contains("Image(systemName: isFavorite ? \"star.fill\" : \"star\")"))
        precondition(libraryView.contains(".opacity(isHovered ? 1 : 0)"))
        precondition(libraryView.contains(".help(isFavorite ? \"Remove Song from Favorites\" : \"Add Song to Favorites\")"))
        precondition(libraryView.contains("private func toggleFavoriteTrack(_ track: FavoriteTrackEntry)"))
        precondition(!libraryView.contains("private func removeFavoriteTrack(_ track: FavoriteTrackEntry)"))
        precondition(libraryView.contains("let cachedAlbumDetail = try appState.libraryStore.cachedFavoriteAlbumDetail(albumID: track.albumID)"))
        precondition(libraryView.contains("try appState.libraryStore.removeFavoriteTrack(track)"))
        precondition(libraryView.contains("removedFavoriteTrackIDs.insert(track.id)"))
        precondition(libraryView.contains("removedFavoriteTrackAlbumDetails[track.id] = cachedAlbumDetail"))
        precondition(libraryView.contains("try appState.libraryStore.restoreFavoriteTrack(\n                    track,\n                    albumDetail: removedFavoriteTrackAlbumDetails[track.id]\n                )"))
        precondition(libraryView.contains("removedFavoriteTrackIDs.remove(track.id)"))
        precondition(libraryView.contains("removedFavoriteTrackAlbumDetails.removeValue(forKey: track.id)"))
        precondition(libraryView.contains("if removedFavoriteTrackIDs.contains(track.id) {"))
        precondition(!libraryView.contains("tracks.removeAll { $0.id == track.id }"))
        precondition(libraryView.contains("static let songFavoriteColumnWidth: CGFloat = 16"))
        precondition(store.contains("func removeFavoriteTrack(_ track: FavoriteTrackEntry) throws"))
        precondition(store.contains("func restoreFavoriteTrack(_ track: FavoriteTrackEntry, albumDetail: AlbumDetail? = nil) throws"))
        precondition(store.contains("if let albumDetail {\n                try upsertFavoriteAlbumDetail(albumDetail, in: db)\n            }"))
        precondition(store.contains("DELETE FROM favorite_tracks WHERE trackID = ?"))
        precondition(store.contains("INSERT INTO favorite_tracks ("))
    }
    ...
    private static func checkAlbumAndTrackFavoriteControlsMatchMusicBehavior() throws {
        ...
        precondition(albumSource.contains("guard !isInsideTopChrome(event) else {"))
        precondition(albumSource.contains("private func isInsideTopChrome(_ event: NSEvent) -> Bool"))
        precondition(albumSource.contains("contentView.convert(event.locationInWindow, from: nil)"))
        precondition(albumSource.contains("if contentView.isFlipped {"))
        precondition(albumSource.contains("return point.y <= contentView.bounds.minY + AlbumDetailLayout.topChromeHitExclusionHeight"))
        precondition(albumSource.contains("return point.y >= topChromeMinY"))
        precondition(albumSource.contains("AlbumDetailLayout.topChromeHitExclusionHeight"))
        precondition(albumSource.contains("static let topChromeHitExclusionHeight = topControlsTopPadding + topControlButtonSize"))
